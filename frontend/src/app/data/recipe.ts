...
export const recipe_foods: Recipe[] = [
  ...
  },
  {
    ...
    Foto: 'Foto-NI',
    Categoria: 'Doces',
    Subcategoria: 'Delícias Tropicais',
    TempoDePreparo: '1 hora',
    Porcoes: '12',
    NivelDeDificuldade: 'Medio',
    Extra: [
  ...
  },
  {
    ...
    Ingredientes: [
      '7 claras em castelo',
      'Mistura-se com 1 copo de açúcar caramelizado',
      '1 cl café de baking soda',
      'panela untada',
    ],
    ModoDeFazer: 'Vai ao forno bem quente Cubra com doce de ovos.',
    Foto: 'Foto-NI',
    Categoria: 'Doces',
    Subcategoria: 'Sobremesas',
    TempoDePreparo: '1 hora',
