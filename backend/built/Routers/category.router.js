    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, category_model_1.CategoryModel.create(category_1.category_recipe)];
            case 2:
                _a.sent();
...
router.get("/:categoria/subcategoria/:subcategoria", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var categoryRegEx, subCategoryRegEx, recipes, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                categoryRegEx = new RegExp(req.params.categoria, "i");
                subCategoryRegEx = new RegExp(req.params.subcategoria, "i");
