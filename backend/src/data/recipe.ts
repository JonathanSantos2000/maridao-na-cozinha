export const recipe_foods: any[] = [
  ...
  },
  {
    ...
    modoDeFazer:
      "Doure a lombo na margarina. Junte o caldo de carne, dissolvido no leite, misture bem. Acrescente o pepino, a pimenta-do-reino, o amendoim e deixe no fogo por 5 minutos. Despeje sobre o macarrão escorrido., Sirva quente.",
    foto: ["Foto-NI"],
    fotoAutor: ["maridão na cozinha"],
    categoria: "Massas",
    subcategoria: "Macarrão",
  ...
  },
  {
    ...
    modoDeFazer:
      "Faça no liquidificador, bata no liquidificador as goiabas com casca, o melão e a água.Coe e sirva em copos com gelo.Se o suco ficar muito consistente adicione um pouco mais de água.",
    foto: ["Foto-NI"],
    fotoAutor: ["maridão na cozinha"],
    categoria: "Bebidas",
    subcategoria: "Sucos",
  ...
  },
  {
    ...
    modoDeFazer:
      "Tempere o lagarto com 1 colher (sopa) da mistura de ervas e com sal a gosto. Aqueça o forno em temperatua quente. Derreta a manteiga ou margarina numa panela grande e doure a carne de todos os lados. Coloque uma assadeira, com 2 xícaras de água e com a colher (sopa) restante da mistura de ervas, na parte inferior do forno. Coloque a carne sobre a grade do forno e asse por cerca de 1 hora, ou mais, se desejar, acrescentado mais água, se necessário.",
    foto: ["Foto-NI"],
    fotoAutor: ["maridão na cozinha"],
    categoria: "Carne",
    subcategoria: "Bovina",
  ...
  },
  {
    ...
    modoDeFazer:
      "Misturar o leite condensado com as gemas, até o creme ficar consistente.Colocar no creme, o queijo e o coco.Assar em forminhas forradas com papel manteiga por 30 minutos.",
    foto: ["Foto-NI"],
    fotoAutor: ["maridão na cozinha"],
    categoria: "Doces",
    subcategoria: "Docinho",
  ...
  },
  {
    ...
    modoDeFazer:
      "Coloque os ingredientes da massa em um recipiente e vá trabalhando com as mãos até obter uma massa homogênea. Unte a forma e forre com a massa.Cubra o frango e o queijo com essa mistura e leve ao forno médio para assar por cerca de 40 minutos.",
    foto: ["Foto-NI"],
    fotoAutor: ["maridão na cozinha"],
    categoria: "Aves",
    subcategoria: "Frango",
    ...
    extra: [
      {
        ...
        modoDeFazer:
          "Faça um refogado com a cebola picada, o molho de tomates, cheiro-verde e acrescente o frango desfiado. Coloque em cima da massa crua, logo após, o queijo cortado em cubinhos. Bata as claras e depois as gemas. Acrescente o creme de leite e tempere com o sal. Coloque uma pitada de fermento.",
      },
    ],
    stars: 0,
    favorite: false,
